...
ConVar force_audio_english( "force_audio_english", "0", FCVAR_ARCHIVE | FCVAR_ARCHIVE_XBOX, "Keeps track of whether we're forcing english in a localized language." );
