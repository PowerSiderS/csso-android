...
// 	}
	...
	VectorSubtract( vPosition, pScratchPad->m_vPlayerOrigin, vSourceVector );
	VectorNormalize( vSourceVector );
	Device_SpatializeChannel( pStructMem->m_flOutput, vSourceVector, flMono, flRearStereoScale );
}
